...
_RESULTS = os.path.join(_ROOT, f"Results/{monkey}/mutual_information/coherence/")

path_mi = os.path.join(_RESULTS, f"mi_{metric}_at_{at}_avg_{avg}_{mcp}.nc")
path_tv = os.path.join(_RESULTS, f"tval_{metric}_at_{at}_avg_{avg}_{mcp}.nc")
path_pv = os.path.join(_RESULTS, f"pval_{metric}_at_{at}_avg_{avg}_{mcp}.nc")
