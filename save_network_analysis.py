...
parser.add_argument("METRIC", help="which metric to load", type=str)
...
_RESULTS = os.path.join(
    "/home/vinicius/funcog/gda", "Results", monkey, sessions[s_id], "session01/network"
)
...
# Assign coords
degree = degree.assign_coords(
    {
        "trials": net.A.trials.data,
